...
// Create banner navigation indicators - Update to accommodate more indicators
function createBannerIndicators() {
    ...
    if (!indicatorsContainer) {
        ...
        indicatorsContainer.style.flexWrap = 'wrap'; // Allow wrapping for more indicators
        indicatorsContainer.style.justifyContent = 'center'; // Center the indicators
        indicatorsContainer.style.maxWidth = '80%'; // Limit width to avoid overflow
    ...
    bannerItems.forEach((_, index) => {
        ...
        indicator.style.margin = '0 2px'; // Add some horizontal margin
